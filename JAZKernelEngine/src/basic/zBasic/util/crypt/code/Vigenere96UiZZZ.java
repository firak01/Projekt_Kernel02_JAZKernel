 ...
 * 
 */
public class Vigenere96UiZZZ extends Vigenere96ZZZ implements IVigenereUiZZZ{
	...
	public Vigenere96UiZZZ() {	  
		super();
	}
	public Vigenere96UiZZZ(String[]saFlagControl) throws ExceptionZZZ {	  
		super(saFlagControl);
	}
	public Vigenere96UiZZZ(String sSchluesselWort) throws ExceptionZZZ {
		super(sSchluesselWort);
	}
	public Vigenere96UiZZZ(String sSchluesselWort, String sFilePath) throws ExceptionZZZ {
