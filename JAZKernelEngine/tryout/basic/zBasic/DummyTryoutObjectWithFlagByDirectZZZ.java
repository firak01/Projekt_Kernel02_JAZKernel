...
public class DummyTryoutObjectWithFlagByDirectZZZ extends AbstractObjectWithFlagZZZ<Object> implements IDummyTryoutObjectWithFlagByDirectZZZ{
	private static final long serialVersionUID = 9214280301056845842L;

	public DummyTryoutObjectWithFlagByDirectZZZ(String[] saFlag) throws ExceptionZZZ {
		super(saFlag);
	}

	public DummyTryoutObjectWithFlagByDirectZZZ() {
		super();
	}
