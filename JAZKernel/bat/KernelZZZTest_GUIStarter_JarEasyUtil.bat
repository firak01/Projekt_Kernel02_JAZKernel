...
java -cp C:\1fgl\client\JAZKernelClient\JAZKernel.jar  basic.zBasic.util.file.JarEasyUtilZZZTestMain > c:\fglkernel\kernellog\JarEasyUtilZZZTest_StarterLog.txt
pause