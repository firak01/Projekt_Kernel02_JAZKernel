...
java -cp C:\1fgl\client\JAZKernelClient\JAZKernel.jar basic.zBasic.util.file.ResourceEasyZZZTestMain > c:\fglkernel\kernellog\ResourceEasyZZZTest_StarterLog.txt
pause