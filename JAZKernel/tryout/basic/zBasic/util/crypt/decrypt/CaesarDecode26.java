...
class CaesarDecode26 {                      // zaehlt die Buchstaben
  ...
  public static void main( String[] arg) {
	    //if (arg.length== 0)  d = new DateiUtil("tryout\\tryout\\zBasic\\util\\crypt\\decrypt\\file\\ROT13ZZZCrypted1.txt");	 
	    //if (arg.length== 0)  d = new DateiUtil("tryout\\tryout\\zBasic\\util\\crypt\\decrypt\\file\\CaesarCrypted1_schluessellaenge3.txt");
	    //if (arg.length== 0)  d = new DateiUtil("tryout\\tryout\\zBasic\\util\\crypt\\decrypt\\file\\CaesarCrypted2_schluessellaenge3.txt");
	  	...
	  	//if (arg.length== 0)  d = new DateiUtil("tryout\\tryout\\zBasic\\util\\crypt\\decrypt\\file\\ROTnnCrypted_schluessellaenge5.txt");
	  	if (arg.length== 0)  d = new DateiUtil("tryout\\tryout\\zBasic\\util\\crypt\\decrypt\\file\\ROTasciiCrypted_schluessellaenge3.txt");
