...
public class TestUtilZZZ {
	...
	public static File createKernelFileUsed() throws ExceptionZZZ {
		...
		main:{
			try {
				...
				objStreamFile.println("Formula1=Der dynamische Wert1 ist '{[Section A]Testentry1}'. FGL rulez.");
				objStreamFile.println("Formula2=Der dynamische Wert2 ist '{[Section B]Testentry2}'. FGL rulez.");
				objStreamFile.println("Formula3=Der dynamische Wert3 ist '{[Section C]Testentry3}'. FGL rulez.");
	...
	//alte Version, in der ein Ini-Path nicht mit geschweiften Klammern umgeben ist, sondern mit <Z>-Tags
	//TODOGOON: Kann geloescht werden, wenn die Loesung mit geschweifter Klammer funktioniert.
	public static File createKernelFileUsed20250221() throws ExceptionZZZ {
		File objReturn = null;
