...
public class EnumMappedStatusLocalAvailableHelperZZZTest  extends TestCase{
   ...
   public void testSearchEnumMappedArray() {
	    	...
	    	try {
		    	...
		    	IEnumSetMappedStatusLocalZZZ[] enumaByInterface = EnumMappedStatusLocalAvailableHelperZZZ.searchEnumMappedArray(objClassByInterface, "STATUSLOCAL", false);
		    	...
		    	//Merke: False gibt an, dass keine Interfaces durchsucht werden sollen   	
		    	IEnumSetMappedStatusLocalZZZ[] enumaByDirect = EnumMappedStatusLocalAvailableHelperZZZ.searchEnumMappedArray(objClassByDirect, "STATUSLOCAL", false);
		    	...
		    	IEnumSetMappedStatusLocalZZZ[] enumaByInterface2 = EnumMappedStatusLocalAvailableHelperZZZ.searchEnumMappedArray(objClassByInterface2, "STATUSLOCAL" );
		    	...
		    	IEnumSetMappedStatusLocalZZZ[] enumaByInterface3 = EnumMappedStatusLocalAvailableHelperZZZ.searchEnumMappedArray(objClassFromInterface, "STATUSLOCAL");
		    	assertNotNull("NULL sollte als Array der IEnumSetMappedStatusZZZ-Objekte NICHT zurueckkommen, da STATUSLOCAL direct eingebunden wird.", enumaByInterface3);
		    	...
		    	IEnumSetMappedZZZ[] enumaByInterface4 = EnumMappedStatusLocalAvailableHelperZZZ.searchEnumMappedArray(objClassFromInterfaceExtended, "STATUSLOCAL");
