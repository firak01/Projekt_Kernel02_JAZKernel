...
// 		} 		
	   ...
	   //####################################
    	try {
	       Class<?> objClass = EnumSetMappedTestTypeZZZ.class;
	  	   ...
	  	   IEnumSetMappedZZZ[] enumaMapped = EnumSetMappedUtilZZZ.toEnumMappedArray(listaenumMapped);
	  	   assertNotNull(enumaMapped);
	  	   assertTrue(enumaMapped.length==3);
		  	
	  	   assertTrue(enumaMapped instanceof IEnumSetMappedZZZ[]);//weil eben nicht einfach "enum" sondern genaues IEnumSetMapped
	  	   assertFalse(enumaMapped instanceof Enum[]); //bingo, ist halt kein einfach "enum"
		   assertFalse(enumaMapped[0] instanceof IEnumSetMappedStatusLocalZZZ);//weil EnumSetMappedTestType das IEnumSetMappdedZZZ implementiert und nicht IEnumSetMappdedStatusLocalZZZ
	   ...
	   //####################################
		try {
			   Class<?> objClassStatus = EnumSetMappedStatusLocalTestTypeZZZ.class;
		  	   Object[] objaStatus = objClassStatus.getEnumConstants();
		  	   
		  	   Enum[] objaEnumStatus = (Enum[]) objaStatus;
		  	   
		  	   //Als Vorbereitung: Das Array in eine Listenform bringen.
		  	   ArrayList<IEnumSetMappedStatusLocalZZZ>listaenumMappedStatus = EnumSetMappedStatusLocalUtilZZZ.toEnumMappedArrayList(objaEnumStatus);
		  	   ...
		  	   //Der eigentliche Test		  	  
		  	   IEnumSetMappedZZZ[] enumaMappedStatus = EnumSetMappedUtilZZZ.toEnumMappedArray(listaenumMappedStatus);
		  	   assertNotNull(enumaMappedStatus);
		  	   assertTrue(enumaMappedStatus.length==3);
			  	
		  	   assertFalse(enumaMappedStatus instanceof IEnumSetMappedStatusLocalZZZ[]);//weil EnumSetMappedTestType das IEnumSetMappdedZZZ implementiert und nicht IEnumSetMappdedStatusLocalZZZ
		  	   assertFalse(enumaMappedStatus instanceof Enum[]); //weil eben nicht einfach "enum" sondern genaues IEnumSetMapped
			   ...
			   assertTrue(enumaMappedStatus[0] instanceof IEnumSetMappedStatusLocalZZZ);//weil EnumSetMappedStatusTestType das IEnumSetMappdedStatusZZZ implementiert und nicht IEnumSetMappdedZZZ  
    ...
    public void testToEnumArrayByMapped() {
    	try {
		    ...
		    Class<?> objClass = EnumSetMappedTestTypeZZZ.class;
		  	...
		  	//Als Vorbereitung: Das Array in eine Listenform bringen.
		  	ArrayList<IEnumSetMappedStatusLocalZZZ>listaenumStatusMapped = EnumSetMappedStatusLocalUtilZZZ.toEnumMappedArrayList(objaEnum);
		  	assertNull("Fehler in der Vorbereitung - sollte aus dem anderen EnumTyp (eins, zwei, drei) kein IEnumSetMappedStatusLocal erstellen können (null-Fall)",listaenumStatusMapped);
			...
			assertFalse(enumaMapped[0] instanceof IEnumSetMappedStatusLocalZZZ);//weil EnumSetMappedTestType das IEnumSetMappdedZZZ implementiert und nicht IEnumSetMappdedStatusZZZ  
			assertTrue(enumaMapped[0] instanceof IEnumSetMappedZZZ);	
    	 } catch (ExceptionZZZ ez) {
 	    	ez.printStackTrace();
 			fail("Method throws an exception." + ez.getMessageLast());
...
//	}
    ...
    public void testToEnumMappedArrayLists() {	
    	try {
		   ...
		   assertFalse(listae.get(0) instanceof IEnumSetMappedStatusLocalZZZ);
    ...
    public void testToEnumArrayByMappedStatus() {
    	try {
    		...
    		//+++++++++++++++++++++++++++++++++
    		//+++ Negativtest
			Class<?> objClassStatus0 = EnumSetMappedStatusLocalTestTypeZZZ.class;
		  	Object[] objaStatus0 = objClassStatus0.getEnumConstants();
		  	  
		  	Enum[] objaEnumStatus0 = (Enum[]) objaStatus0;
		  	   
		  	//Als Vorbereitung: Das Array in eine Listenform bringen.
		  	ArrayList<IEnumSetMappedZZZ>listaenumMappedStatus0 = EnumSetMappedUtilZZZ.toEnumMappedArrayList(objaEnumStatus0);
		  	//assertNull("Fehler in der Vorbereitung - sollte die Arraylist nicht erstellen können (not null-Fall)",listaenumMappedStatus0);
		  	assertNotNull("Fehler in der Vorbereitung - kann keine passende Arraylist erstellen (null-Fall)",listaenumMappedStatus0);
		  	
		  	Enum[] enumaMappedStatus0 = EnumSetMappedUtilZZZ.toEnumArrayByMapped(listaenumMappedStatus0);
		  	assertNotNull(enumaMappedStatus0);
		  	assertTrue(enumaMappedStatus0.length==3);
				
		  	assertFalse(enumaMappedStatus0 instanceof IEnumSetMappedStatusLocalZZZ[]);//weil eben enum
		  	assertTrue(enumaMappedStatus0 instanceof Enum[]); //bingo
			assertTrue(enumaMappedStatus0[0] instanceof IEnumSetMappedZZZ);//
			assertTrue(enumaMappedStatus0[0] instanceof IEnumSetMappedStatusLocalZZZ);//wg Vererbung
		  	
		  	
		  	//++++++++++++++++++++++++++++++++++
		  	//+++ Der eigentliche Test
		  	Class<?> objClassStatus1 = EnumSetMappedTestTypeZZZ.class;
		  	Object[] objaStatus1 = objClassStatus1.getEnumConstants();
		  	
		  	Enum[] objaEnumStatus1 = (Enum[]) objaStatus1;
		  	
		  	//Als Vorbereitung: Das Array in eine Listenform bringen.
		  	ArrayList<IEnumSetMappedZZZ>listaenumMappedStatus1 = EnumSetMappedUtilZZZ.toEnumMappedArrayList(objaEnumStatus1);
		    assertNotNull("Fehler in der Vorbereitung - kann keine passende Arraylist erstellen (null-Fall)",listaenumMappedStatus1);
		  	
		  	Enum[] enumaMappedStatus1 = EnumSetMappedUtilZZZ.toEnumArrayByMapped(listaenumMappedStatus1);
		  	assertNotNull(enumaMappedStatus1);
		  	assertTrue(enumaMappedStatus1.length==3);
				
		  	assertFalse(enumaMappedStatus1 instanceof IEnumSetMappedStatusLocalZZZ[]);//weil eben enum
		  	assertTrue(enumaMappedStatus1 instanceof Enum[]); //bingo
			assertTrue(enumaMappedStatus1[0] instanceof IEnumSetMappedZZZ);
			assertFalse(enumaMappedStatus1[0] instanceof IEnumSetMappedStatusLocalZZZ);
	    }catch(ExceptionZZZ ez) {
			ez.printStackTrace();
			fail("Method throws an exception: " + ez.getMessageLast());
		}
