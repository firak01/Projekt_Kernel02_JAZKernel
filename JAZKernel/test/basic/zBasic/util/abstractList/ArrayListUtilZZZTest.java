...
/**
 * Wegen der CAST - Problematik alle Methoden, die mit einem "EnumSetMapped" und dem Ergebnis einer ArrayList zu tun haben raus.
 * Verwende statt desssen die Util-Klasse des jeweiligen "EnumSetMapped". Z.B. EnumSetMappedStatusLocalUtilZZZ.toEnumArray...
 * 
...
//		   //Erst einmal aus dem Enum eine ArrayList machen.
//		   ArrayListZZZ listaEnumExtended = new ArrayListZZZ(objaEnum);
//		   ArrayList<IEnumSetMappedStatusLocalZZZ> listaEnum = listaEnumExtended.toArrayList();
//		   
//		 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//		   //Test: Aus der ArrayList ein Enum-Array machen
//		   //Das gibt eine Class Cast Exception... Enum[]  objaResultToEnumArray = ArrayListZZZ.toEnumMappedArrayByMapped(listaEnum);
...
//		   assertTrue(objaResultToEnumArray.length==3);
//		   
//		   assertFalse(objaResultToEnumArray instanceof IEnumSetMappedStatusLocalZZZ[]);
//		   assertTrue(objaResultToEnumArray instanceof Enum[]);
//		   
...
//		   assertFalse(objaResultToEnumArray[0] instanceof IEnumSetMappedStatusLocalZZZ); //trotz IEnumSetMappedStatusZZZ extends IEnumSetMappedZZZ. Aber die Enums im Objekt sind halt so definiert als IEnumSetMappedZZZ
//		   
//		   assertTrue(objaResultToEnumArray[0] instanceof EnumSetMappedTestTypeZZZ);
//		   
//		   
...
//	   ArrayList<IEnumSetMappedStatusLocalZZZ> listaEnumWithoutStatus = listaEnumExtendedWithoutStatus.toArrayList();
...
//	   ArrayList<IEnumSetMappedStatusLocalZZZ> listaEnumWithStatus = listaEnumExtendedWithStatus.toArrayList();
