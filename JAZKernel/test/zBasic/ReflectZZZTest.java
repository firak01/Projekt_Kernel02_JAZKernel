...
//		}
	...
	public void testGetPositionCurrent(){
		String sClassCurrent = this.getClass().getName(); 
		String sMethodCurrentLined = ReflectCodeZZZ.getMethodCurrentNameLined(2);//2 ist das Offset, weil die Zeilennummer erste für 2 Zeilen später berechnet werden soll. 
