...
public class FileIniZZZTest extends TestCase {
	...
	protected void setUp(){
		try {			
			...
			//TODO Default construktor in der Klasse zur verf�gung stellenobjFileInit = new FileIniZZZ();
			...
			assertFalse(objFileIniTest.getFlag("init")==true); //Nun w�re init falsch
	...
	* Lindhauer; 22.04.2006 13:18:49
	...
	public void testSetProperty(){
		try {
			//Bestehenden Wert in einer bestehenden Section �ndern
