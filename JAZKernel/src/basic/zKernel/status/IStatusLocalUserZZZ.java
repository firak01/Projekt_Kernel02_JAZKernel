...
public interface IStatusLocalUserZZZ extends IStatusLocalBasicUserZZZ, ICircularBufferStatusBooleanUserZZZ{	
	...
	public abstract boolean offerStatusLocalEnum(IEnumSetMappedStatusLocalZZZ enumStatusLocal, boolean bStatusValue);//Merke: Das offer kommt vom dem intern verwendeten CircularBuffer Klasse
	...
	public abstract boolean setStatusLocalEnum(int iIndexOfProcess, IEnumSetMappedStatusLocalZZZ enumStatusMapped, boolean bStatusValue) throws ExceptionZZZ;
