...
public interface IKernelConfigSectionEntryUserZZZ {
	...
	public void adoptEntryValuesMissing(IKernelConfigSectionEntryZZZ objEntry) throws ExceptionZZZ; //Damit holt man die Werte aus einem Reference-Entry in das eigene interne Entry.
	public void resetEntry() throws ExceptionZZZ;
}
