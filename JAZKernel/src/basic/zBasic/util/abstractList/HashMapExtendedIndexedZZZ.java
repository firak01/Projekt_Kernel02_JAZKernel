 ...
 *
 */
public class HashMapExtendedIndexedZZZ<T,X> extends HashMap implements  IConstantZZZ{
	...
	public static boolean checkStructure(HashMap hmIndexed, boolean bQuiet) throws ExceptionZZZ{
		...
		main:{
			if(hmIndexed==null){
				ExceptionZZZ ez = new ExceptionZZZ("HashMap", iERROR_PARAMETER_MISSING, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
				throw ez;
			}			 
			...
			while(itKey.hasNext()){
				...
				if(obj.getClass()!= Integer.class){
					if(bQuiet){
						...
						ExceptionZZZ ez = new ExceptionZZZ("HashMap contains key which is no Integer-Object. (" + obj.getClass().getName() + ")", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
						throw ez;
					}
				}
			}//end while
			...
			while(itSet.hasNext()){
				...
				if(obj2==null){
					if(bQuiet){
						...
						ExceptionZZZ ez = new ExceptionZZZ("HashMap contains entry which is null.", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
						throw ez;
					}
				}else{
					...
					if(obj2b.getClass()!= ArrayList.class){
						if(bQuiet){
							...
							ExceptionZZZ ez = new ExceptionZZZ("HashMap contains entry which is no ArrayList-Object. (" + obj2b.getClass().getName() + ")", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
							throw ez;
						}
					}//end if
					...
					for(int icount=0; icount< alSet.size(); icount++){
						...
						if(obj3==null){
							if(bQuiet){
								...
								ExceptionZZZ ez = new ExceptionZZZ("HashMap contains ArrayListEntry which contains a null element.", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
								throw ez;
							}
						}else{
							if(obj3.getClass()!= Integer.class){
								if(bQuiet){
									...
									ExceptionZZZ ez = new ExceptionZZZ("HashMap contains ArrayListEntry which contains an element which is no Integer-Object. (" + obj3.getClass().getName() + ")", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
									throw ez;
								}
							}
						}//end for icount
	...
	public boolean checkStructure(boolean bQuiet) throws ExceptionZZZ{
		...
		main:{
			bReturn = HashMapExtendedIndexedZZZ.checkStructure(this, bQuiet);
		}//end main
		return bReturn;
	}
	...
	* lindhaueradmin; 18.05.2011 06:02:54
	 * @throws ExceptionZZZ 
	 */
	public static HashMapExtendedIndexedZZZ getValueDupsIndexedByMethod(ArrayList objAl, String sMethodName) throws ExceptionZZZ{
...
//					+++ Suche nun nach der Methode im Objekt.
	...
	* lindhauer; 17.05.2011 11:37:46
	 */
	public static int removeDupsFromByIndex( ArrayList objAl, HashMapExtendedIndexedZZZ hmIndexed, String sFlagRemainIn) throws ExceptionZZZ{
		int iReturn = 0;
		main:{
		if(objAl==null){
			ExceptionZZZ ez = new ExceptionZZZ("ArrayList to compare", iERROR_PARAMETER_MISSING,   HashMapExtendedZZZ.class.getName(), ReflectCodeZZZ.getMethodCurrentName());								  
		...
		if(hmIndexed==null){
			ExceptionZZZ ez = new ExceptionZZZ("HashMapIndexed", iERROR_PARAMETER_MISSING, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
			throw ez;
		}			 
		if(hmIndexed.size()==0) break main;
		...
		if(btemp==false){
		   String sMessage = null;	
			...
			ExceptionZZZ ez = new ExceptionZZZ("HashMapIndexed has no valid structure. " + sMessage, iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
			throw ez;
		}
		...
		if(StringZZZ.isEmpty(sFlagRemainIn)){
			...
			if(sFlagRemain!="KEEPLAST" && sFlagRemain != "KEEPFIRST"){
				ExceptionZZZ ez = new ExceptionZZZ("Wrong reamining Flag (=" + sFlagRemain + "). Expected 'KEEPFIRST' / 'KEEPLAST'.", iERROR_PARAMETER_VALUE, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
				throw ez;
			}
		}
	...
	* lindhauer; 17.05.2011 11:37:46
	 */
	public static int removeDupsFromByIndex(HashMap hm, HashMapExtendedIndexedZZZ hmIndexed, String sFlagRemainIn) throws ExceptionZZZ{
		int iReturn = 0;
		main:{
		if(hm == null){
			ExceptionZZZ ez = new ExceptionZZZ("HashMap", iERROR_PARAMETER_MISSING, HashMapExtendedIndexedZZZ.class.getName(),  ReflectCodeZZZ.getMethodCurrentName());
...
public int removeDupsFrom(HashMap hm, String sFlagRemain) throws ExceptionZZZ{
	int iReturn = 0;
	main:{
		iReturn = HashMapExtendedIndexedZZZ.removeDupsFromByIndex(hm, this, sFlagRemain);
	}
	return iReturn;
}
}//end class
