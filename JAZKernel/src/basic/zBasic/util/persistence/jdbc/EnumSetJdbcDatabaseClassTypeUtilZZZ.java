...
public class EnumSetJdbcDatabaseClassTypeUtilZZZ extends EnumSetUtilZZZ{	
	public EnumSetJdbcDatabaseClassTypeUtilZZZ(){		
	}
	public EnumSetJdbcDatabaseClassTypeUtilZZZ(EnumSet<?>enumSetUsed){
		this.setEnumSetCurrent(enumSetUsed);
	}
	public EnumSetJdbcDatabaseClassTypeUtilZZZ(Class<?>objClass)throws ExceptionZZZ{
		super(objClass);		
	}
	public EnumSetJdbcDatabaseClassTypeUtilZZZ(IEnumSetFactoryZZZ objEnumSetFactory, Class<?> objClass) throws ExceptionZZZ{
		super(objEnumSetFactory, objClass);
	}
	public EnumSetJdbcDatabaseClassTypeUtilZZZ(IEnumSetFactoryZZZ objEnumSetFactory){
	...
	public boolean startsWithAnyDescription(String sToFind){
		...
		main:{
			...
			bReturn = EnumSetJdbcDatabaseClassTypeUtilZZZ.startsWithAnyDescription(myEnumSet, sToFind);
		}
		return bReturn;
	}
...
//			  System.out.println(ReflectCodeZZZ.getPositionCurrent() + ": Driver als driver.abbreviaton from Enumeration="+driver.getAbbreviation());
	...
	public Integer readEnumConstant_FirstIndexValueByDescription(String sDescription) throws ExceptionZZZ {
		...
		main:{
			...
			intReturn = EnumSetJdbcDatabaseClassTypeUtilZZZ.readEnumConstant_FirstIndexValueByDescription(this.getEnumSetCurrent(), sDescription);
		}//end main:
		return intReturn;
	}
