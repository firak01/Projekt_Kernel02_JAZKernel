...
public enum CryptCipherTypeZZZ implements IEnumSetMappedZZZ{//Folgendes geht nicht, da alle Enums schon von einer Java BasisKlasse erben... extends EnumSetMappedBaseZZZ{
	ROT13("rot13","simple encrytption methode for the characters a-z"),
	ROT13Numeric("rot13numeric","simple encrytption methode for the characters a-z PLUS 0-9"),
	ROTNN("rotnn","simple encrytption methode for the characters provided by a character list");
