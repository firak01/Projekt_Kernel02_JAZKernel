...
public class FileFilterPrefixZipZZZ extends ObjectZZZ implements IFilenameFilterZipZZZ  {
	private String sFilePrefix;
	
	public FileFilterPrefixZipZZZ() {
		super();
	}
	public FileFilterPrefixZipZZZ(String sFilePrefix){
		super();
