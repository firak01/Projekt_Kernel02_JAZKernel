...
public class JarEasyInCurrentJarZZZ  implements IConstantZZZ,IResourceHandlingObjectZZZ{
	...
	public static File searchResourceToDummy(String sPath, String sTargetDirectoryPathRootIn) throws ExceptionZZZ {
		File objReturn = null;
		main:{
			File[] objaReturn = JarEasyInCurrentJarZZZ.searchResource_(sPath, sTargetDirectoryPathRootIn, false, false);
			if(objaReturn!=null) {
	 ...
	 * @throws ExceptionZZZ 
	 */
	private static File[] searchResource_(String sPath, String sTargetDirectoryPathRootIn, boolean bWithFiles, boolean bSave) throws ExceptionZZZ {
