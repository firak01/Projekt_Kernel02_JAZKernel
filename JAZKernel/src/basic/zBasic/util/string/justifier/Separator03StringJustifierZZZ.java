 ...
 * 
 */
public class Separator03StringJustifierZZZ extends AbstractStringJustifierZZZ {
	...
	protected Separator03StringJustifierZZZ() throws ExceptionZZZ{
		super();
	}
	...
	public static IStringJustifierZZZ getInstance() throws ExceptionZZZ{
		if(objStringJustifierINSTANCE==null){
			...
			synchronized(Separator03StringJustifierZZZ.class) {
				if(objStringJustifierINSTANCE == null) {
	...
	public static IStringJustifierZZZ getNewInstance() throws ExceptionZZZ{
		...
		objStringJustifierINSTANCE = new Separator03StringJustifierZZZ();
		return (IStringJustifierZZZ)objStringJustifierINSTANCE;
	}
	...
	public String getPositionSeparatorDefault() throws ExceptionZZZ {
		return IStringJustifierZZZ.sSEPARATOR_03_DEFAULT;
