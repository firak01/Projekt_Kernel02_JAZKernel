 ...
 * 
 */
public class Separator04StringJustifierZZZ extends AbstractStringJustifierZZZ {
	...
	protected Separator04StringJustifierZZZ() throws ExceptionZZZ{
		super();
	}
	...
	public static IStringJustifierZZZ getInstance() throws ExceptionZZZ{
		if(objStringJustifierINSTANCE==null){
			...
			synchronized(Separator04StringJustifierZZZ.class) {
				if(objStringJustifierINSTANCE == null) {
	...
	public static IStringJustifierZZZ getNewInstance() throws ExceptionZZZ{
		...
		objStringJustifierINSTANCE = new Separator04StringJustifierZZZ();
		return (IStringJustifierZZZ)objStringJustifierINSTANCE;
	}
	...
	public String getPositionSeparatorDefault() throws ExceptionZZZ {
		return IStringJustifierZZZ.sSEPARATOR_04_DEFAULT;
