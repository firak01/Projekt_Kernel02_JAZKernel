...
public interface IReflectCodeZZZ{
	...
	public static final String sPOSITION_IN_FILE_SEPARATOR = " ~";    //Merke: Damit wird eine ggfs. errechnete Position im Code abgegrenzt.
	public static final String sPOSITION_IN_FILE_IDENTIFIER = IReflectCodeZZZ.sPOSITION_IN_FILE_SEPARATOR + "";    //Merke: Falls dies wieder z.B. Buendig gemacht werden soll, oder so.
