...
public abstract class AbstractProgramWithFlagOnStatusLocalListeningZZZ extends AbstractObjectWithFlagOnStatusLocalListeningZZZ implements IListenerProgramStatusLocalZZZ{
	 ...
	 * @throws ExceptionZZZ 
	 */
	public AbstractProgramWithFlagOnStatusLocalListeningZZZ() throws ExceptionZZZ {
		super();
		AbstractProgramNew_();
	}
	
	public AbstractProgramWithFlagOnStatusLocalListeningZZZ(String[]saFlag) throws ExceptionZZZ {
		super(saFlag);
		AbstractProgramNew_();
	}
	
	public AbstractProgramWithFlagOnStatusLocalListeningZZZ(HashMap<String,Boolean> hmFlag) throws ExceptionZZZ {
		super(hmFlag);
		AbstractProgramNew_();
	}
