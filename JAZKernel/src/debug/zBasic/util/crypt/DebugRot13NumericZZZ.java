...
public class DebugRot13NumericZZZ {
	...
	public static void main(String[] args) {
        ...
        List<String> listRot13 = ROTnumericZZZ.cryptAll(input,false);
        //String rot13 = ArrayListZZZ.implode((ArrayList<?>) listRot13, "");
        String rot13 = listRot13.get(1);
        
        List<String> listRoundTrip = ROTnumericZZZ.cryptAll(rot13,false);
        ...
        List<String> listRoundTrip2 = ROTnumericZZZ.cryptAll(rot13,false);
