...
java -cp C:\1fgl\client\JAZKernel\JAZKernel.jar  basic.zBasic.util.file.JarEasyInCurrentJarZZZTestMain > c:\fglkernel\kernellog\JarEasyInCurrentJarZZZTest_StarterLog.txt
pause